export function FullScreenIcon({className, onClick} : {className?: any, onClick?: () => void} ) {
  return <>
    
    <svg onClick={onClick} className={className}  version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" 
             viewBox="0 0 384.97 384.97" spacing="preserve" fill="currentColor" stroke="currentColor">
    <g>
            <g id="Fullscreen_1_">
